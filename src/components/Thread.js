/*
  Para el tiempo (time) instalamos el paquete moment : npm i moment , esto para poder usar el timestamp
*/
...
const Thread = ({user, filteredThread, setOpenPopUp, getThreads, setInteractingThread}) => {
    ...
    //console.log('filteredThreads', filteredThread)
    ...
    return (
      <article className="feed-card">
        ...
        <div className="text-container">
          <div>
              <div className="img-container"><img src={user.img} alt="profile avatar"/></div>
              <div>
